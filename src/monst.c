...
#define SEDUCTION_ATTACKS_NO        /* parser skip*/ \
    ...
    MON("Lolth", S_DEMON,                                       /* EvilHack */
        LVL(67, 16, -10, 70, -15), (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4), 
          ATTK(AT_WEAP, AD_PHYS, 2, 4),
    ...
    MON("Geryon", S_DEMON,
        LVL(72, 18, -3, 75, 15), (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 5, 6), 
          ATTK(AT_CLAW, AD_PHYS, 6, 6),
          ATTK(AT_STNG, AD_DRST, 3, 8), 
          ATTK(AT_MAGC, AD_CLRC, 5, 6),
          NO_ATTK, NO_ATTK),
    ...
    MON("Baalzebub", S_DEMON,
        LVL(89, 14, -5, 85, 20), (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_BITE, AD_DRST, 4, 6), 
          ATTK(AT_GAZE, AD_STUN, 2, 6),
          ATTK(AT_MAGC, AD_CLRC, 4, 6), 
          ATTK(AT_MAGC, AD_SPEL, 3, 4), NO_ATTK, NO_ATTK),
    ...
    MON("Asmodeus", S_DEMON,
        LVL(105, 16, -7, 90, 20), (G_HELL | G_NOCORPSE | G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 6), 
